...
class GenerativeModel(ABC):
    ...
    def _build_feature_extractor_layers(self,
                                        image_shape,
                                        output_width,
                                        channels=None,
                                        kernel_widths=None,
                                        ...
                                        add_noise=False):
        """Build a model layers that maps images to some feature space."""
    ...
    def _build_feature_extractor(self,
        ...
        input_layer, X = self._build_feature_extractor_layers(
            image_shape,
            output_width,
            channels=channels,
...
class SpyingAutoEncodingGenerativeAdversarialNetwork(AutoEncodingGenerativeAdversarialNetwork):
    input_layer = None
    X = None
    ...
    def _build_feature_extractor_layers_singleton(self,
                                                  image_shape,
                                                  output_width,
                                                  channels=None,
                                                  kernel_widths=None,
                                                  ...
                                                  init=RandomNormal(mean=0, stddev=0.02),
                                                  add_noise=False):
        if self.input_layer is None or self.X is None:
            self.input_layer, self.X = self._build_feature_extractor_layers(
                image_shape,
                output_width,
                channels=channels,
                kernel_widths=kernel_widths,
        ...
        return self.input_layer, self.X
    ...
    def _build_encoder(self,
        ...
        input_layer, X = self._build_feature_extractor_layers_singleton(
            image_shape,
            latent_dim,
            channels=channels,
            kernel_widths=kernel_widths,
